...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/cube.txt", "../Engine/data/stone02.tga",
								 "../Engine/data/bump02.tga", "../Engine/data/spec02.tga");
	if(!result)
	{
